...
validate.validators.validState = function(value, options, key, attributes) {
  ...
  if( !stateAbbreviations.indexOf(value.toUpperCase()) ){
    return 'must be a valid US State abbreviation';
  }
