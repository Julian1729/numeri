...
const LoginPage = ({ logInUser }) => {
  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      {state.invalidCredentials && <p>Invalid Credentials</p>}
      <form noValidate onSubmit={attemptAuthorization}>
        <TextField
          ...
          helperText={
            state.formErrors.email ? state.formErrors.email.join(', ') : ''
          }
        />
        <TextField
          variant="outlined"
          ...
          helperText={
            state.formErrors.password
              ? state.formErrors.password.join(', ')
              : ''
          }
        />
